...
%   D(n,n)=0;
    ...
    %NW corner*******from top view NW corner
               ...
               if (i==1 && j==1) && k==1
                  ...
                  d_Ey1 = - (((x(i+1)-x(i))*(z(k+1)-z(k)))/(0.5*y(j+2)-0.5*y(j)))*(sigma(a(1),b(1),c(1))*L_te(j,i,k)*0.5*(y(j+1)-y(j))+sigma(j,i,k)*L_te(a(1),b(1),c(1))*0.5*(y(j+2)-y(j+1)))/(sigma(j,i,k)*0.5*(y(j+2)-y(j+1))+sigma(a(1),b(1),c(1))*0.5*(y(j+1)-y(j)))/wsize(1);
                  if c(2) == 0     
                      d_Ey2 = 0;   
                  else
                      d_Ey2 = - (((x(i+1)-x(i))*(z(k+1)-z(k)))/(0.5*y(j+2)-0.5*y(j)))*(sigma(a(2),b(2),c(2))*L_te(j,i,k)*0.5*(y(j+1)-y(j))+sigma(j,i,k)*L_te(a(2),b(2),c(2))*0.5*(y(j+2)-y(j+1)))/(sigma(j,i,k)*0.5*(y(j+2)-y(j+1))+sigma(a(2),b(2),c(2))*0.5*(y(j+1)-y(j)))/wsize(1);     
                  end
                  if c(3) == 0      
                      d_Ey3 = 0;     
                  else
                      d_Ey3 = - (((x(i+1)-x(i))*(z(k+1)-z(k)))/(0.5*y(j+2)-0.5*y(j)))*(sigma(a(3),b(3),c(3))*L_te(j,i,k)*0.5*(y(j+1)-y(j))+sigma(j,i,k)*L_te(a(3),b(3),c(3))*0.5*(y(j+2)-y(j+1)))/(sigma(j,i,k)*0.5*(y(j+2)-y(j+1))+sigma(a(3),b(3),c(3))*0.5*(y(j+1)-y(j)))/wsize(1);      
                  end
                  if c(4) == 0         
                      d_Ey4 = 0;    
                  else
                      d_Ey4 = - (((x(i+1)-x(i))*(z(k+1)-z(k)))/(0.5*y(j+2)-0.5*y(j)))*(sigma(a(4),b(4),c(4))*L_te(j,i,k)*0.5*(y(j+1)-y(j))+sigma(j,i,k)*L_te(a(4),b(4),c(4))*0.5*(y(j+2)-y(j+1)))/(sigma(j,i,k)*0.5*(y(j+2)-y(j+1))+sigma(a(4),b(4),c(4))*0.5*(y(j+1)-y(j)))/wsize(1);       
                  end
                  if c(5) == 0         
                      d_Ey5 = 0;         
                  else
                      d_Ey5 = - (((x(i+1)-x(i))*(z(k+1)-z(k)))/(0.5*y(j+2)-0.5*y(j)))*(sigma(a(5),b(5),c(5))*L_te(j,i,k)*0.5*(y(j+1)-y(j))+sigma(j,i,k)*L_te(a(5),b(5),c(5))*0.5*(y(j+2)-y(j+1)))/(sigma(j,i,k)*0.5*(y(j+2)-y(j+1))+sigma(a(5),b(5),c(5))*0.5*(y(j+1)-y(j)))/wsize(1);        
                  end
                  ...
                  d_P  = -(d_Ex + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Ez);
                D(n,[n  (n+DY3D) (n+(DY3D*DX3D))]) = [d_P  d_Ex d_Ez];
                D(n,[nEy1 nEy2 nEy3 nEy4 nEy5]) = [d_Ey1 d_Ey2 d_Ey3 d_Ey4 d_Ey5]; 
               %max z
               elseif (i==1 && j==1) && k==DZ3D
                  ...
                  d_P  = -(d_Ex + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Wz); 
               ...
               elseif (i==DX3D && j==1) && k==1
                  ...
                  d_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  d_P  = -(d_Wx + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Ez);
               ...
               elseif (i==DX3D && j==1) && k==DZ3D
                  ...
                  d_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k))); 
                  d_P  = -(d_Wx + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Wz);
    ...
    % edges
              ...
              %NW edge*******from top view NW corner
               elseif (i==1 && j==1)
                  ...
                  d_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  d_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k))); 
                  d_P  = -(d_Ex + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Ez + d_Wz);
               ...
               elseif (i==1 && k==1)
                  ...
                  d_Wy = - (((x(i+1)-x(i))*(z(k+1)-z(k)))/(0.5*y(j+1)-0.5*y(j-1)))*(sigma(j-1,i,k)*L_te(j,i,k)*0.5*(y(j+1)-y(j))+sigma(j,i,k)*L_te(j-1,i,k)*0.5*(y(j)-y(j-1)))/(sigma(j,i,k)*0.5*(y(j)-y(j-1))+sigma(j-1,i,k)*0.5*(y(j+1)-y(j)));
                  d_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  d_P  = -(d_Ex + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Wy + d_Ez);
                D(n,[(n-1) n  (n+DY3D) (n+(DY3D*DX3D))]) = [d_Wy d_P  d_Ex d_Ez];
                D(n,[nEy1 nEy2 nEy3 nEy4 nEy5]) = [d_Ey1 d_Ey2 d_Ey3 d_Ey4 d_Ey5]; 
               ...
               elseif (i==1 && k==DZ3D)
                  ...
                  d_Wy = - (((x(i+1)-x(i))*(z(k+1)-z(k)))/(0.5*y(j+1)-0.5*y(j-1)))*(sigma(j-1,i,k)*L_te(j,i,k)*0.5*(y(j+1)-y(j))+sigma(j,i,k)*L_te(j-1,i,k)*0.5*(y(j)-y(j-1)))/(sigma(j,i,k)*0.5*(y(j)-y(j-1))+sigma(j-1,i,k)*0.5*(y(j+1)-y(j)));
                  d_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k))); 
                  d_P  = -(d_Ex + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Wy + d_Wz);
                D(n,[(n-(DY3D*DX3D)) (n-1) n  (n+DY3D)]) = [d_Wz d_Wy d_P d_Ex];
                D(n,[nEy1 nEy2 nEy3 nEy4 nEy5]) = [d_Ey1 d_Ey2 d_Ey3 d_Ey4 d_Ey5]; 
               ...
               elseif (j==1 && k==1)
                  ...
                  d_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  d_P  = -(d_Ex + d_Wx + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Ez);
               ...
               elseif (j==1 && k==DZ3D)
                  ...
                  d_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k))); 
                  d_P  = -(d_Ex + d_Wx + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Wz);
               ...
               elseif (i==DX3D && j==1)
                  ...
                  d_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  d_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k))); 
                  d_P  = -(d_Wx + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Ez + d_Wz);
               ...
               elseif (i==DX3D && k==1)
                  ...
                  d_Wy = - (((x(i+1)-x(i))*(z(k+1)-z(k)))/(0.5*y(j+1)-0.5*y(j-1)))*(sigma(j-1,i,k)*L_te(j,i,k)*0.5*(y(j+1)-y(j))+sigma(j,i,k)*L_te(j-1,i,k)*0.5*(y(j)-y(j-1)))/(sigma(j,i,k)*0.5*(y(j)-y(j-1))+sigma(j-1,i,k)*0.5*(y(j+1)-y(j)));
                  d_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  d_P  = -(d_Wx + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Wy + d_Ez);
                D(n,[(n-DY3D) (n-1) n  (n+(DY3D*DX3D))]) = [d_Wx d_Wy d_P  d_Ez];
                D(n,[nEy1 nEy2 nEy3 nEy4 nEy5]) = [d_Ey1 d_Ey2 d_Ey3 d_Ey4 d_Ey5]; 
               %E edge max z     
               elseif (i==DX3D && k==DZ3D)
                  ...
                  d_Wy = - (((x(i+1)-x(i))*(z(k+1)-z(k)))/(0.5*y(j+1)-0.5*y(j-1)))*(sigma(j-1,i,k)*L_te(j,i,k)*0.5*(y(j+1)-y(j))+sigma(j,i,k)*L_te(j-1,i,k)*0.5*(y(j)-y(j-1)))/(sigma(j,i,k)*0.5*(y(j)-y(j-1))+sigma(j-1,i,k)*0.5*(y(j+1)-y(j)));
                  d_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k))); 
                  d_P  = -(d_Wx + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Wy + d_Wz);
                D(n,[(n-(DY3D*DX3D)) (n-DY3D) (n-1) n ]) = [d_Wz d_Wx d_Wy d_P ];
                D(n,[nEy1 nEy2 nEy3 nEy4 nEy5]) = [d_Ey1 d_Ey2 d_Ey3 d_Ey4 d_Ey5]; 
    ...
    %faces
               ...
               elseif i==1
                  ...
                  d_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  d_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k))); 
                  d_P  = -(d_Ex + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Wy + d_Ez + d_Wz);
                D(n,[(n-(DY3D*DX3D)) (n-1) n  (n+DY3D) (n+(DY3D*DX3D))]) = [d_Wz d_Wy d_P  d_Ex d_Ez];
                D(n,[nEy1 nEy2 nEy3 nEy4 nEy5]) = [d_Ey1 d_Ey2 d_Ey3 d_Ey4 d_Ey5]; 
               ...
               elseif j==1
                  ...
                  d_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  d_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k))); 
                  d_P  = -(d_Ex + d_Wx + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Ez + d_Wz);
               ...
               %near face******from top view top face
                elseif k==1
                  ...
                  d_Wy = - (((x(i+1)-x(i))*(z(k+1)-z(k)))/(0.5*y(j+1)-0.5*y(j-1)))*(sigma(j-1,i,k)*L_te(j,i,k)*0.5*(y(j+1)-y(j))+sigma(j,i,k)*L_te(j-1,i,k)*0.5*(y(j)-y(j-1)))/(sigma(j,i,k)*0.5*(y(j)-y(j-1))+sigma(j-1,i,k)*0.5*(y(j+1)-y(j)));
                  d_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  d_P  = -(d_Ex + d_Wx + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Wy + d_Ez);
                D(n,[(n-DY3D) (n-1) n (n+DY3D) (n+(DY3D*DX3D))]) = [d_Wx d_Wy d_P  d_Ex d_Ez];
                D(n,[nEy1 nEy2 nEy3 nEy4 nEy5]) = [d_Ey1 d_Ey2 d_Ey3 d_Ey4 d_Ey5]; 
               %far face******from top view bottom face                
                elseif k==DZ3D
                  ...
                  d_Wy = - (((x(i+1)-x(i))*(z(k+1)-z(k)))/(0.5*y(j+1)-0.5*y(j-1)))*(sigma(j-1,i,k)*L_te(j,i,k)*0.5*(y(j+1)-y(j))+sigma(j,i,k)*L_te(j-1,i,k)*0.5*(y(j)-y(j-1)))/(sigma(j,i,k)*0.5*(y(j)-y(j-1))+sigma(j-1,i,k)*0.5*(y(j+1)-y(j)));
                  d_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k))); 
                  d_P  = -(d_Ex + d_Wx + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Wy + d_Wz);
                D(n,[(n-(DY3D*DX3D)) (n-DY3D) (n-1) n (n+DY3D)]) = [d_Wz d_Wx d_Wy d_P  d_Ex];  
                D(n,[nEy1 nEy2 nEy3 nEy4 nEy5]) = [d_Ey1 d_Ey2 d_Ey3 d_Ey4 d_Ey5];  
               ...
               elseif i==DX3D
                  ...
                  d_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  d_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k))); 
                  d_P  = -(d_Wx + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Wy + d_Ez + d_Wz);
                D(n,[(n-(DY3D*DX3D)) (n-DY3D) (n-1) n (n+(DY3D*DX3D))]) = [d_Wz d_Wx d_Wy d_P  d_Ez];  
                D(n,[nEy1 nEy2 nEy3 nEy4 nEy5]) = [d_Ey1 d_Ey2 d_Ey3 d_Ey4 d_Ey5];      
    ...
    %non boundary
                  ...
                  d_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  d_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_te(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_te(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k))); 
                  d_P  = -(d_Ex + d_Wx + d_Ey1 + d_Ey2 + d_Ey3 + d_Ey4 + d_Ey5 + d_Wy + d_Ez + d_Wz);    
                D(n,[(n-(DY3D*DX3D)) (n-DY3D) (n-1) n  (n+DY3D) (n+(DY3D*DX3D))]) = [d_Wz d_Wx d_Wy d_P  d_Ex d_Ez];
                D(n,[nEy1 nEy2 nEy3 nEy4 nEy5]) = [d_Ey1 d_Ey2 d_Ey3 d_Ey4 d_Ey5]; 
