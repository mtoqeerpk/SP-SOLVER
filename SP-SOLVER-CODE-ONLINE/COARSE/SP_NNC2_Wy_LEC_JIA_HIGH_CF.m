...
%   C(n,n)=0;
    ...
    %NW corner*******from top view NW corner
               ...
               elseif (i==1 && j==DY3D) && k==1
                  ...
                  c_Ex = - (((y(j+1)-y(j))*(z(k+1)-z(k)))/(0.5*x(i+2)-0.5*x(i)))*(sigma(j,i+1,k)*L_ec(j,i,k)*0.5*(x(i+1)-x(i))+sigma(j,i,k)*L_ec(j,i+1,k)*0.5*(x(i+2)-x(i+1)))/(sigma(j,i,k)*0.5*(x(i+2)-x(i+1))+sigma(j,i+1,k)*0.5*(x(i+1)-x(i))); 
                 c_Wy1 = - (((x(i+1)-x(i))*(z(k+1)-z(k)))/(0.5*y(j+1)-0.5*y(j-1)))*(sigma(a(1),b(1),c(1))*L_ec(j,i,k)*0.5*(y(j+1)-y(j))+sigma(j,i,k)*L_ec(a(1),b(1),c(1))*0.5*(y(j)-y(j-1)))/(sigma(j,i,k)*0.5*(y(j)-y(j-1))+sigma(a(1),b(1),c(1))*0.5*(y(j+1)-y(j)))/wsize(1);  
                 if c(2) == 0   
                     c_Wy2 = 0;  
                 else
                     c_Wy2 = - (((x(i+1)-x(i))*(z(k+1)-z(k)))/(0.5*y(j+1)-0.5*y(j-1)))*(sigma(a(2),b(2),c(2))*L_ec(j,i,k)*0.5*(y(j+1)-y(j))+sigma(j,i,k)*L_ec(a(2),b(2),c(2))*0.5*(y(j)-y(j-1)))/(sigma(j,i,k)*0.5*(y(j)-y(j-1))+sigma(a(2),b(2),c(2))*0.5*(y(j+1)-y(j)))/wsize(1);   
                 end
                 if c(3) == 0      
                     c_Wy3 = 0;    
                 else
                     c_Wy3 = - (((x(i+1)-x(i))*(z(k+1)-z(k)))/(0.5*y(j+1)-0.5*y(j-1)))*(sigma(a(3),b(3),c(3))*L_ec(j,i,k)*0.5*(y(j+1)-y(j))+sigma(j,i,k)*L_ec(a(3),b(3),c(3))*0.5*(y(j)-y(j-1)))/(sigma(j,i,k)*0.5*(y(j)-y(j-1))+sigma(a(3),b(3),c(3))*0.5*(y(j+1)-y(j)))/wsize(1);     
                 end
                 if c(4) == 0         
                     c_Wy4 = 0;         
                 else
                     c_Wy4 = - (((x(i+1)-x(i))*(z(k+1)-z(k)))/(0.5*y(j+1)-0.5*y(j-1)))*(sigma(a(4),b(4),c(4))*L_ec(j,i,k)*0.5*(y(j+1)-y(j))+sigma(j,i,k)*L_ec(a(4),b(4),c(4))*0.5*(y(j)-y(j-1)))/(sigma(j,i,k)*0.5*(y(j)-y(j-1))+sigma(a(4),b(4),c(4))*0.5*(y(j+1)-y(j)))/wsize(1);         
                 end
                 if c(5) == 0          
                     c_Wy5 = 0;         
                 else
                     c_Wy5 = - (((x(i+1)-x(i))*(z(k+1)-z(k)))/(0.5*y(j+1)-0.5*y(j-1)))*(sigma(a(5),b(5),c(5))*L_ec(j,i,k)*0.5*(y(j+1)-y(j))+sigma(j,i,k)*L_ec(a(5),b(5),c(5))*0.5*(y(j)-y(j-1)))/(sigma(j,i,k)*0.5*(y(j)-y(j-1))+sigma(a(5),b(5),c(5))*0.5*(y(j+1)-y(j)))/wsize(1);        
                 end
                  c_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Ex + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Ez);
                C(n,[n (n+DY3D) (n+(DY3D*DX3D))]) = [ c_P c_Ex c_Ez]; 
                C(n,[nWy1 nWy2 nWy3 nWy4 nWy5]) = [c_Wy1 c_Wy2 c_Wy3 c_Wy4 c_Wy5]; 
               %max z
               elseif (i==1 && j==DY3D) && k==DZ3D
                 ...
                 if c(5) == 0             
                  ...
                  c_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Ex + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Wz);
               ...
               elseif (i==DX3D && j==DY3D) && k==1
                 ...
                 if c(5) == 0      
                  ...
                  c_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Wx + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Ez);
               ...
               elseif (i==DX3D && j==DY3D) && k==DZ3D
                 ...
                 if c(5) == 0        
                  ...
                  c_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Wx + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Wz);
              ...
              %NW edge*******from top view NW corner
               ...
               elseif (i==1 && j==DY3D)
                 ...
                 if c(5) == 0       
                  ...
                  c_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  c_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Ex + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Ez + c_Wz);
               ...
               elseif (i==1 && k==1)
                 ...
                 if c(5) == 0         
                  ...
                  c_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Ex + c_Ey + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Ez);
                C(n,[ n (n+1) (n+DY3D) (n+(DY3D*DX3D))]) = [ c_P c_Ey c_Ex c_Ez];
                C(n,[nWy1 nWy2 nWy3 nWy4 nWy5]) = [c_Wy1 c_Wy2 c_Wy3 c_Wy4 c_Wy5];
               ...
               elseif (i==1 && k==DZ3D)
                 ...
                 if c(5) == 0       
                  ...
                  c_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Ex + c_Ey + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Wz);
                C(n,[(n-(DY3D*DX3D)) n (n+1) (n+DY3D)]) = [c_Wz  c_P c_Ey c_Ex];
                C(n,[nWy1 nWy2 nWy3 nWy4 nWy5]) = [c_Wy1 c_Wy2 c_Wy3 c_Wy4 c_Wy5];
               ...
               elseif (j==DY3D && k==1)
                 ...
                 if c(5) == 0         
                  ...
                  c_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Ex + c_Wx + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Ez);
               ...
               elseif (j==DY3D && k==DZ3D)
                 ...
                 if c(5) == 0 
                  ...
                  c_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Ex + c_Wx + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Wz);
               ...
               elseif (i==DX3D && j==DY3D)
                 ...
                 if c(5) == 0           
                  ...
                  c_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  c_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Wx + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Ez + c_Wz);
               ...
               elseif (i==DX3D && k==1)
                 ...
                 if c(5) == 0     
                  ...
                  c_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Wx + c_Ey + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Ez);
                C(n,[(n-DY3D) n (n+1) (n+(DY3D*DX3D))]) = [c_Wx  c_P c_Ey c_Ez];
                C(n,[nWy1 nWy2 nWy3 nWy4 nWy5]) = [c_Wy1 c_Wy2 c_Wy3 c_Wy4 c_Wy5];
               %E edge max z     
               elseif (i==DX3D && k==DZ3D)
                 ...
                 if c(5) == 0        
                  ...
                  c_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Wx + c_Ey + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Wz);
                C(n,[(n-(DY3D*DX3D)) (n-DY3D) n (n+1)]) = [c_Wz c_Wx  c_P c_Ey];
                C(n,[nWy1 nWy2 nWy3 nWy4 nWy5]) = [c_Wy1 c_Wy2 c_Wy3 c_Wy4 c_Wy5];
    ...
    %faces
               ...
               elseif i==1
                 ...
                 if c(5) == 0       
                  ...
                  c_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  c_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Ex + c_Ey + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Ez + c_Wz);
                C(n,[(n-(DY3D*DX3D)) n (n+1) (n+DY3D) (n+(DY3D*DX3D))]) = [c_Wz  c_P c_Ey c_Ex c_Ez];
                C(n,[nWy1 nWy2 nWy3 nWy4 nWy5]) = [c_Wy1 c_Wy2 c_Wy3 c_Wy4 c_Wy5];
               ...
               elseif j==DY3D
                 ...
                 if c(5) == 0        
                  ...
                  c_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  c_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Ex + c_Wx + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Ez + c_Wz);
               ...
               %near face******from top view top face
                elseif k==1
                 ...
                 if c(5) == 0           
                  ...
                  c_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Ex + c_Wx + c_Ey + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Ez);
                C(n,[(n-DY3D) n (n+1) (n+DY3D) (n+(DY3D*DX3D))]) = [c_Wx  c_P c_Ey c_Ex c_Ez];
                C(n,[nWy1 nWy2 nWy3 nWy4 nWy5]) = [c_Wy1 c_Wy2 c_Wy3 c_Wy4 c_Wy5];
               %far face******from top view bottom face                
                elseif k==DZ3D
                 ...
                 if c(5) == 0           
                  ...
                  c_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Ex + c_Wx + c_Ey + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Wz);
                C(n,[(n-(DY3D*DX3D)) (n-DY3D)  n (n+1) (n+DY3D)]) = [c_Wz c_Wx  c_P c_Ey c_Ex];  
                C(n,[nWy1 nWy2 nWy3 nWy4 nWy5]) = [c_Wy1 c_Wy2 c_Wy3 c_Wy4 c_Wy5];  
               ...
               elseif i==DX3D
                 ...
                 if c(5) == 0       
                  ...
                  c_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  c_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Wx + c_Ey + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Ez + c_Wz);
                C(n,[(n-(DY3D*DX3D)) (n-DY3D) n (n+1) (n+(DY3D*DX3D))]) = [c_Wz c_Wx  c_P c_Ey c_Ez];
                C(n,[nWy1 nWy2 nWy3 nWy4 nWy5]) = [c_Wy1 c_Wy2 c_Wy3 c_Wy4 c_Wy5];     
    ...
    %non boundary
                 ...
                 if c(5) == 0     
                  ...
                  c_Ez = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+2)-0.5*z(k)))*(sigma(j,i,k+1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k+1)*0.5*(z(k+2)-z(k+1)))/(sigma(j,i,k)*0.5*(z(k+2)-z(k+1))+sigma(j,i,k+1)*0.5*(z(k+1)-z(k)));
                  c_Wz = - (((x(i+1)-x(i))*(y(j+1)-y(j)))/(0.5*z(k+1)-0.5*z(k-1)))*(sigma(j,i,k-1)*L_ec(j,i,k)*0.5*(z(k+1)-z(k))+sigma(j,i,k)*L_ec(j,i,k-1)*0.5*(z(k)-z(k-1)))/(sigma(j,i,k)*0.5*(z(k)-z(k-1))+sigma(j,i,k-1)*0.5*(z(k+1)-z(k)));
                  c_P  = -(c_Ex + c_Wx + c_Ey + c_Wy1 + c_Wy2 + c_Wy3 + c_Wy4 + c_Wy5 + c_Ez + c_Wz);                   
                C(n,[(n-(DY3D*DX3D)) (n-DY3D) n (n+1) (n+DY3D) (n+(DY3D*DX3D))]) = [c_Wz c_Wx  c_P c_Ey c_Ex c_Ez];
                C(n,[nWy1 nWy2 nWy3 nWy4 nWy5]) = [c_Wy1 c_Wy2 c_Wy3 c_Wy4 c_Wy5];       
