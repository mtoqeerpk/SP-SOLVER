...
%   B(n,n)=0;
    ...
    %NW corner*******from top view NW corner
               ...
               elseif (i==DX3D && j==1) && k==1
                  B(n,[(n-DY3D) n (n+1) (n+(DY3D*DX3D))]) = [0 0 0 0];
                  if (L_ek(j,i,k)*L_ek(a(1),b(1),c(1)))==0  
                      b_Wx1 = 0;           
                  else
                      b_Wx1 = - (((y(j+1)-y(j))*(z(k+1)-z(k)))/(0.5*x(i+1)-0.5*x(i-1)))*(sigma(a(1),b(1),c(1))*L_ek(j,i,k)*0.5*(x(i+1)-x(i))+sigma(j,i,k)*L_ek(a(1),b(1),c(1))*0.5*(x(i)-x(i-1)))/(sigma(j,i,k)*0.5*(x(i)-x(i-1))+sigma(a(1),b(1),c(1))*0.5*(x(i+1)-x(i)))/wsize(1);    
                  end
                  if c(2) == 0    
                      b_Wx2 = 0;   
                  else
                      if (L_ek(j,i,k)*L_ek(a(2),b(2),c(2)))==0   
                          ...
                          b_Wx2 = - (((y(j+1)-y(j))*(z(k+1)-z(k)))/(0.5*x(i+1)-0.5*x(i-1)))*(sigma(a(2),b(2),c(2))*L_ek(j,i,k)*0.5*(x(i+1)-x(i))+sigma(j,i,k)*L_ek(a(2),b(2),c(2))*0.5*(x(i)-x(i-1)))/(sigma(j,i,k)*0.5*(x(i)-x(i-1))+sigma(a(2),b(2),c(2))*0.5*(x(i+1)-x(i)))/wsize(1);    
                      end
                  end
                  if c(3) == 0      
                      b_Wx3 = 0;    
                      ...
                      if (L_ek(j,i,k)*L_ek(a(3),b(3),c(3)))==0   
                          ...
                          b_Wx3 = - (((y(j+1)-y(j))*(z(k+1)-z(k)))/(0.5*x(i+1)-0.5*x(i-1)))*(sigma(a(3),b(3),c(3))*L_ek(j,i,k)*0.5*(x(i+1)-x(i))+sigma(j,i,k)*L_ek(a(3),b(3),c(3))*0.5*(x(i)-x(i-1)))/(sigma(j,i,k)*0.5*(x(i)-x(i-1))+sigma(a(3),b(3),c(3))*0.5*(x(i+1)-x(i)))/wsize(1);    
                      end
                  end
                  if c(4) == 0    
                      b_Wx4 = 0;  
                      ...
                      if (L_ek(j,i,k)*L_ek(a(4),b(4),c(4)))==0    
                          ...
                          b_Wx4 = - (((y(j+1)-y(j))*(z(k+1)-z(k)))/(0.5*x(i+1)-0.5*x(i-1)))*(sigma(a(4),b(4),c(4))*L_ek(j,i,k)*0.5*(x(i+1)-x(i))+sigma(j,i,k)*L_ek(a(4),b(4),c(4))*0.5*(x(i)-x(i-1)))/(sigma(j,i,k)*0.5*(x(i)-x(i-1))+sigma(a(4),b(4),c(4))*0.5*(x(i+1)-x(i)))/wsize(1);       
                      end
                  end
                  if c(5) == 0      
                      b_Wx5 = 0;     
                      ...
                      if (L_ek(j,i,k)*L_ek(a(5),b(5),c(5)))==0    
                          ...
                          b_Wx5 = - (((y(j+1)-y(j))*(z(k+1)-z(k)))/(0.5*x(i+1)-0.5*x(i-1)))*(sigma(a(5),b(5),c(5))*L_ek(j,i,k)*0.5*(x(i+1)-x(i))+sigma(j,i,k)*L_ek(a(5),b(5),c(5))*0.5*(x(i)-x(i-1)))/(sigma(j,i,k)*0.5*(x(i)-x(i-1))+sigma(a(5),b(5),c(5))*0.5*(x(i+1)-x(i)))/wsize(1);       
                      end
                  end
                  if (L_ek(j,i,k)*L_ek(j+1,i,k))==0    
                      b_Ey = 0;                 
                  ...
                  b_P  = -(b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Ey + b_Ez);
                B(n,[ n (n+1) (n+(DY3D*DX3D))]) = [ b_P b_Ey b_Ez];
                B(n,[nWx1 nWx2 nWx3 nWx4 nWx5]) = [b_Wx1 b_Wx2 b_Wx3 b_Wx4 b_Wx5]; 
               %max z
               elseif (i==DX3D && j==1) && k==DZ3D
                   B(n,[(n-(DY3D*DX3D)) (n-DY3D) n (n+1)]) = [0 0 0 0];
                  if (L_ek(j,i,k)*L_ek(a(1),b(1),c(1)))==0   
                      b_Wx1 = 0;      
                  else
                      b_Wx1 = - (((y(j+1)-y(j))*(z(k+1)-z(k)))/(0.5*x(i+1)-0.5*x(i-1)))*(sigma(a(1),b(1),c(1))*L_ek(j,i,k)*0.5*(x(i+1)-x(i))+sigma(j,i,k)*L_ek(a(1),b(1),c(1))*0.5*(x(i)-x(i-1)))/(sigma(j,i,k)*0.5*(x(i)-x(i-1))+sigma(a(1),b(1),c(1))*0.5*(x(i+1)-x(i)))/wsize(1);
                  ...
                  b_P  = -(b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Ey + b_Wz);
               ...
               elseif (i==DX3D && j==DY3D) && k==1
                  ...
                  b_P  = -(b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Wy + b_Ez);
               ...
               elseif (i==DX3D && j==DY3D) && k==DZ3D
                  ...
                  b_P  = -(b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Wy + b_Wz);
    ...
    % edges
              ...
              %NW edge*******from top view NW corner
               ...
               elseif (j==1 && k==1)
                  ...
                  b_P  = -(b_Ex + b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Ey + b_Ez);
                B(n,[n (n+1) (n+DY3D) (n+(DY3D*DX3D))]) = [ b_P b_Ey b_Ex b_Ez]; 
                B(n,[nWx1 nWx2 nWx3 nWx4 nWx5]) = [b_Wx1 b_Wx2 b_Wx3 b_Wx4 b_Wx5];               
               ...
               elseif (j==1 && k==DZ3D)
                  ...
                  b_P  = -(b_Ex + b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Ey + b_Wz);
                 B(n,[(n-(DY3D*DX3D)) n (n+1) (n+DY3D)]) = [b_Wz  b_P b_Ey b_Ex];
                B(n,[nWx1 nWx2 nWx3 nWx4 nWx5]) = [b_Wx1 b_Wx2 b_Wx3 b_Wx4 b_Wx5]; 
               ...
               elseif (j==DY3D && k==1)
                  ...
                  b_P  = -(b_Ex + b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Wy + b_Ez);
                B(n,[(n-1) n (n+DY3D) (n+(DY3D*DX3D))]) = [ b_Wy b_P b_Ex b_Ez];
                B(n,[nWx1 nWx2 nWx3 nWx4 nWx5]) = [b_Wx1 b_Wx2 b_Wx3 b_Wx4 b_Wx5]; 
               ...
               elseif (j==DY3D && k==DZ3D)
                  ...
                  b_P  = -(b_Ex + b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Wy + b_Wz);
                B(n,[(n-(DY3D*DX3D))  (n-1) n (n+DY3D)]) = [b_Wz  b_Wy b_P b_Ex];
                B(n,[nWx1 nWx2 nWx3 nWx4 nWx5]) = [b_Wx1 b_Wx2 b_Wx3 b_Wx4 b_Wx5]; 
                %NE edge******from top view NE corner
               elseif (i==DX3D && j==1)
                  B(n,[(n-(DY3D*DX3D)) (n-DY3D) n (n+1) (n+(DY3D*DX3D))]) = [0 0 0 0 0];
                  if (L_ek(j,i,k)*L_ek(a(1),b(1),c(1)))==0    
                      b_Wx1 = 0;          
                  else
                      b_Wx1 = - (((y(j+1)-y(j))*(z(k+1)-z(k)))/(0.5*x(i+1)-0.5*x(i-1)))*(sigma(a(1),b(1),c(1))*L_ek(j,i,k)*0.5*(x(i+1)-x(i))+sigma(j,i,k)*L_ek(a(1),b(1),c(1))*0.5*(x(i)-x(i-1)))/(sigma(j,i,k)*0.5*(x(i)-x(i-1))+sigma(a(1),b(1),c(1))*0.5*(x(i+1)-x(i)))/wsize(1);       
                  ...
                  b_P  = -(b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Ey + b_Ez + b_Wz);
               ...
               elseif (i==DX3D && j==DY3D)
                  ...
                  b_P  = -(b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Wy + b_Ez + b_Wz);
               ...
               elseif (i==DX3D && k==1)
                  ...
                  b_P  = -(b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Ey + b_Wy + b_Ez);
               ...
               elseif (i==DX3D && k==DZ3D)
                  ...
                  b_P  = -(b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Ey + b_Wy + b_Wz);
    ...
    %faces
               ...
               elseif j==1
                  ...
                  b_P  = -(b_Ex + b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Ey + b_Ez + b_Wz);
                B(n,[(n-(DY3D*DX3D)) n (n+1) (n+DY3D) (n+(DY3D*DX3D))]) = [b_Wz  b_P b_Ey b_Ex b_Ez];
                B(n,[nWx1 nWx2 nWx3 nWx4 nWx5]) = [b_Wx1 b_Wx2 b_Wx3 b_Wx4 b_Wx5]; 
               ...
               elseif j==DY3D
                  ...
                  b_P  = -(b_Ex + b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Wy + b_Ez + b_Wz);
                B(n,[(n-(DY3D*DX3D)) (n-1) n (n+DY3D) (n+(DY3D*DX3D))]) = [b_Wz  b_Wy b_P b_Ex b_Ez];
                B(n,[nWx1 nWx2 nWx3 nWx4 nWx5]) = [b_Wx1 b_Wx2 b_Wx3 b_Wx4 b_Wx5]; 
               %near face******from top view top face
                elseif k==1
                  ...
                  b_P  = -(b_Ex + b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Ey + b_Wy + b_Ez);
                B(n,[(n-1) n (n+1) (n+DY3D) (n+(DY3D*DX3D))]) = [ b_Wy b_P b_Ey b_Ex b_Ez];
                B(n,[nWx1 nWx2 nWx3 nWx4 nWx5]) = [b_Wx1 b_Wx2 b_Wx3 b_Wx4 b_Wx5]; 
               %far face******from top view bottom face                
                elseif k==DZ3D
                  ...
                  b_P  = -(b_Ex + b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Ey + b_Wy + b_Wz);
                B(n,[(n-(DY3D*DX3D))  (n-1) n (n+1) (n+DY3D)]) = [b_Wz  b_Wy b_P b_Ey b_Ex];    
                B(n,[nWx1 nWx2 nWx3 nWx4 nWx5]) = [b_Wx1 b_Wx2 b_Wx3 b_Wx4 b_Wx5]; 
               ...
               elseif i==DX3D
                  ...
                  b_P  = -(b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Ey + b_Wy + b_Ez + b_Wz);
    ...
    %non boundary
                  ...
                  b_P  = -(b_Ex + b_Wx1 + b_Wx2 + b_Wx3 + b_Wx4 + b_Wx5 +  b_Ey + b_Wy + b_Ez + b_Wz);    
                B(n,[(n-(DY3D*DX3D)) (n-1) n (n+1) (n+DY3D) (n+(DY3D*DX3D))]) = [b_Wz  b_Wy b_P b_Ey b_Ex b_Ez];
                B(n,[nWx1 nWx2 nWx3 nWx4 nWx5]) = [b_Wx1 b_Wx2 b_Wx3 b_Wx4 b_Wx5];   
